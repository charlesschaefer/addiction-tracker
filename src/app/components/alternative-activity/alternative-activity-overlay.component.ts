...
export class AlternativeActivityOverlayComponent {
    ...
    select(activityId: number) {
        ...
        this.selectedActivity = { id: activityId, name: this.getActivityName(activityId) };
    ...
    private startBreathingAnimation(): void {
        ...
        this.breathingTimerId = setInterval(() => {
            ...
            const currentDuration = stepDurations[this.breathingStep as keyof typeof stepDurations];
            
            // Calculate progress percentage
            this.breathingProgress = Math.min(100, (elapsed / currentDuration) * 100);
    ...
    getBreathingInstruction(): string {
        switch (this.breathingStep) {
            case 1: return 'Inhale slowly through your nose...';
            case 2: return 'Hold your breath...';
            case 3: return 'Exhale slowly through your mouth...';
            case 4: return 'Hold briefly...';
            default: return '';
        }
    }
